...
source_title: Why SNHU chose Brightspace as their LMS
source_url: https://www.d2l.com/why-d2l/customers/southern-new-hampshire-university/
...
related_notes:
  ...
  - title: "Objection - Integration Risk"
    ...
    why: "This story demonstrates successful integration with partner/third-party systems, addressing integration-risk concerns."
  - title: "Objection - Implementation Capacity"
    relationship: "overcomes-objection"
    why: "This story shows a manageable implementation/onboarding process, addressing capacity concerns."
---
# Customer Story - Southern New Hampshire University - Why SNHU chose Brightspace as their LMS

## Verified fact

A published customer-story record exists for Southern New Hampshire University. This imported note has been promoted to verified vault status by human override.

## Signal

- Published story summary: To manage the current and anticipated growth, it became clear that SNHU needed to upgrade their LMS. Their existing legacy product simply wasn’t flexible enough, nor able to grow at the pace that SNHU required.
- Products/services named in the export: Brightspace Core, Technical Support Services, Learning Services, Partner Integration.
- Use cases tagged in the export: Cloud Infrastructure, Student Success, Implementation & Migration, Fully Online, Accessibility, Blackboard.
- Learners listed: 90,000+.
...
- [Southern New Hampshire University customer story](https://www.d2l.com/why-d2l/customers/southern-new-hampshire-university/)
